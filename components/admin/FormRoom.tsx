...
// // // //           value={values.floorId}
// // // //           onChange={(e) =>
// // // //             setValues({ ...values, floorId: Number(e.target.value) })
// // // //           }
...
// // //         price: initialValues.price ?? 0,
// // //         status: initialValues.status ?? "",
// // //         imageFile: null, // user can re-upload
// // //       });
// // //     } else {
// // //       setValues({ floorId: "", price: 0, status: "", imageFile: null });
// // //     }
// // //   }, [initialValues]);
...
// // //             <select
// // //               value={values.floorId}
// // //               onChange={(e) => setValues((prev: any) => ({ ...prev, floorId: Number(e.target.value) }))}
// // //               className="w-full border rounded-xl px-3 py-2 text-gray-900 focus:ring-2 focus:ring-indigo-500"
// // //             >
// // //               <option value="">Select Floor...</option>
// // //               {floors.map((f) => (
...
// // //               type="number"
// // //               value={values.price}
// // //               onChange={(e) => setValues((prev: any) => ({ ...prev, price: Number(e.target.value) }))}
// // //               className="w-full border rounded-xl px-3 py-2 text-gray-900 focus:ring-2 focus:ring-indigo-500"
// // //             />
// // //           </div>
...
// // //             <select
// // //               value={values.status}
// // //               onChange={(e) => setValues((prev: any) => ({ ...prev, status: e.target.value }))}
// // //               className="w-full border rounded-xl px-3 py-2 text-gray-900 focus:ring-2 focus:ring-indigo-500"
// // //             >
// // //               <option value="">Select Status...</option>
// // //               <option value="AVAILABLE">AVAILABLE</option>
...
// // //               >
// // //                 {values.imageFile ? (
// // //                   <img src={URL.createObjectURL(values.imageFile)} alt="Preview" className="h-28 object-cover rounded-lg" />
// // //                 ) : (
// // //                   <div className="flex flex-col items-center justify-center text-gray-500">
// // //                     <svg className="w-10 h-10 mb-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
// // //                       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16V4m0 0L3 8m4-4l4 4M21 12h-4m0 0l-4-4m4 4l-4 4"/>
// // //                     </svg>
// // //                     <span className="text-sm">Click to upload or drag & drop</span>
// // //                   </div>
// // //                 )}
...
// // //                   accept="image/*"
// // //                   className="hidden"
// // //                   onChange={(e) => setValues((prev: any) => ({ ...prev, imageFile: e.target.files?.[0] ?? null }))}
// // //                 />
// // //               </label>
// // //             </div>
// // //             {values.imageFile && <p className="text-sm text-gray-600 mt-2">Selected: {values.imageFile.name}</p>}
// // //           </div>
// // //         </div>
...
// // //           <button onClick={handleSave} className="px-5 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700">
// // //             {isEdit ? "Update" : "Save"}
// // //           </button>
// // //         </div>
// // //       </div>
...
// //   function handleSave() {
// //     // in edit mode, only send status + imageFile
// //     if (isEdit) {
// //       onSave({ status: values.status, imageFile: values.imageFile });
// //     } else {
// //       onSave(values);
// //     }
// //   }
...
// //         <div className="space-y-6">
// //           {/* Floor & Price (read-only in edit mode) */}
// //           {!isEdit && (
// //             <>
// //               <div>
// //                 <label className="block text-sm font-semibold text-gray-700 mb-2">Floor</label>
...
export default function FormRoom({
  ...
  function handleSave() {
  if (isEdit) {
    // ✅ edit mode: only send status + imageFile
    onSave({
      status: values.status,
      imageFile: values.imageFile,
    });
  ...
  return (
    ...
    <div className="relative z-10 bg-white rounded-xl shadow-lg p-6 w-[360px] animate-fadeIn">
  ...
  <div className="space-y-4">
    ...
    <div>
      ...
      <select
        value={values.floorId}
        onChange={(e) => setValues((prev: any) => ({ ...prev, floorId: Number(e.target.value) }))}
        className="w-full border rounded-lg px-2 py-1 text-gray-900 focus:ring-2 focus:ring-indigo-500"
      >
        <option value="">Select Floor...</option>
        {floors.map((f) => (
          <option key={f.id} value={f.id}>{f.name}</option>
    ...
    {/* Image Upload */}
    <div>
      <label className="block text-sm font-semibold text-gray-700 mb-1">Room Image</label>
      <label
        htmlFor="imageFile"
        className="flex flex-col items-center justify-center w-full h-24 border-2 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition"
      >
        {values.imageFile ? (
          <img src={URL.createObjectURL(values.imageFile)} alt="Preview" className="h-20 object-cover rounded-md" />
        ) : (
  ...
  <div className="flex justify-end space-x-3 mt-6">
    <button onClick={onCancel} className="px-3 py-1 bg-gray-200 rounded hover:bg-gray-300 text-sm">Cancel</button>
    <button onClick={handleSave} className="px-4 py-1 bg-indigo-600 text-white rounded hover:bg-indigo-700 text-sm">
      {isEdit ? "Update" : "Save"}
    </button>
  </div>
</div>
